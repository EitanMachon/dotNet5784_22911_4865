...
/// </summary>
internal class LevelCollection : IEnumerable //  the class that gonna implement the IEnumerable of the level
{
...
internal class StatusCollection : IEnumerable //  the class that gonna implement the IEnumerable of the status
{
